...
Running the build.py script without any arguments starts the Build Environment in GUI mode. At this stage the user is prompted to select the module model, the base board model, the boot mode and software for later use.
