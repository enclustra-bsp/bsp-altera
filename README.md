...
Please refer to the [user documentation](http://enclustra.github.io/ebe-docs/user-doc-altera/) located inside this repository for more information about the usage of the build system.
